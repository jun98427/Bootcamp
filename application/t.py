...
class CameraApp(QWidget):
    def __init__(self):
        ...
        # ▶ "다른 결과 보러가기" 버튼 추가
        # self.regame_button = QPushButton("다른 결과 보러가기", self)
        # self.regame_button.setStyleSheet("""
        #     QPushButton {
        #         font-size: 20px;
        #         font-weight: bold;
        #         color: black;
        ...
        #     }
        # """)
        # self.regame_button.setGeometry(620, 500, 120, 60)
        # self.regame_button.clicked.connect(self.re_game)
        # # self.regame_button.show()
        # self.regame_button.hide()
